...
PYTHONPATH=$CODE_ROOT torchrun --nnodes=1 --nproc_per_node=4  scripts/train_ms.py configs/opensora/train/16x256x256_ms_a100.py   --data-path ${DATAPATH}   --ckpt-path pretrained_models/OpenSora-v1-HQ-16x256x256.pth
# torchrun --nnodes=1 --master-port=8899 --nproc_per_node=1 scripts/train_ms.py configs/opensora/train/16x256x256_ms.py --data-path /home/v-zongyili/Open-Sora/ucf101_train.csv --ckpt-path OpenSora-v1-HQ-16x256x256.pth
