...
def main():
    ...
    if cfg.sample_name is not None:
        ...
        sample_name = "sample_ours_vqgan_3000"
    ...
    for i in range(0, len(prompts), cfg.batch_size):
        ...
        for k in range(cfg.num_sample):
            ...
            # sampling
            z = torch.randn(len(batch_prompts), vae.get_out_channels(), *latent_size, device=device, dtype=dtype)
            ...
            samples = vae.post_vq_conv(samples.to(dtype))
            samples = vae.decoder(samples)
